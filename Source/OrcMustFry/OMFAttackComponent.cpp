...
void UOMFAttackComponent::TickComponent(float DeltaTime, ELevelTick TickType, FActorComponentTickFunction* ThisTickFunction)
{
	...
	if (nullptr != OwnerCharacter && CurrentWeapon != nullptr && CurrentWeapon->IsValidLowLevel() && nullptr != OwnerCharacter->GetController())
	{
...
void UOMFAttackComponent::DestroyWeapon()
{
